...
{
    public class ProdCarritosController : Controller
    {
        private readonly ApplicationDbContext _context;

        public ProdCarritosController(ApplicationDbContext context)
        {
            _context = context;
        }
