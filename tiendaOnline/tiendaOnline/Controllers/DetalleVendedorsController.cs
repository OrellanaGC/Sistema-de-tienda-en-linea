...
{
    public class DetalleVendedorsController : Controller
    {
        private readonly ApplicationDbContext _context;

        public DetalleVendedorsController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: DetalleVendedors
        ...
        // GET: DetalleVendedors/Details/5
        ...
        // GET: DetalleVendedors/Create
        public IActionResult Create()
        {
            ViewData["tiendaOnlineUserID"] = new SelectList(_context.Users, "Id", "Id");
            ViewData["TipoVendedor"] = new SelectList("Particular", "Privado");
            return View();
        }

        // POST: DetalleVendedors/Create
        ...
        // POST: DetalleVendedors/Delete/5
