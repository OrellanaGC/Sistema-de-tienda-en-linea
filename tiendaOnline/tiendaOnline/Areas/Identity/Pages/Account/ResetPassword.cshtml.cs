...
namespace tiendaOnline.Areas.Identity.Pages.Account
{
    ...
    public class ResetPasswordModel : PageModel
    {
        ...
        public ResetPasswordModel(UserManager<tiendaOnlineUser> userManager)
        {
        ...
        public IActionResult OnGet(string code = null)
        {
            if (code == null)
            {
                return BadRequest("Un código debe ser proporcionado para el restablecimiento de contraseña.");
            }
            else
            {
